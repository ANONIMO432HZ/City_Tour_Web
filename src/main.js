...
const imageFiles = [
  ...
  { id: 11, file: "cuidadela_huayra_patamarca.png", name: "Ciudadela Huayra Patamarca", category: "Cultura", desc: "Restos prehispánicos en las cumbres que vigilan el valle fértil. Un testimonio mudo de la grandeza de las civilizaciones locales que desafiaron las alturas.", map: "Ciudadela+Huayra+Patamarca+Huanta", embed: "https://maps.app.goo.gl/KUsYwSiXPuqeaL9w9" },
